module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c39 = function(pattern) { return builders.build_matcher_iterable([pattern]); },
        peg$c40 = "_",
        peg$c41 = { type: "literal", value: "_", description: "\"_\"" },
        peg$c42 = function() { return builders.build_matcher_any(); },
        peg$c43 = "true",
        peg$c44 = { type: "literal", value: "true", description: "\"true\"" },
        peg$c45 = function() { return builders.build_matcher_boolean(true); },
        peg$c46 = "false",
        peg$c47 = { type: "literal", value: "false", description: "\"false\"" },
        peg$c48 = function() { return builders.build_matcher_boolean(false); },
        peg$c49 = "null",
        peg$c50 = { type: "literal", value: "null", description: "\"null\"" },
        peg$c51 = function() { return builders.build_matcher_null(); },
        peg$c52 = function(number) { return builders.build_matcher_number(parseFloat(number)); },
        peg$c53 = function(string) { return builders.build_matcher_string(string); },
        peg$c54 = function(regex) { return builders.build_matcher_regex(regex); },
        peg$c55 = "!<",
        peg$c56 = { type: "literal", value: "!<", description: "\"!<\"" },
        peg$c57 = ":",
        peg$c58 = { type: "literal", value: ":", description: "\":\"" },
        peg$c59 = function(key, valueMatcher) { var keyMatcher = builders.build_matcher_string(key);
                  return builders.build_matcher_pair(keyMatcher, valueMatcher); },
        peg$c60 = function(key) { var keyMatcher = builders.build_matcher_string(key);
                  return builders.build_matcher_pair(keyMatcher, builders.build_matcher_any()); },
        peg$c61 = function(valueMatcher) { return builders.build_matcher_pair(builders.build_matcher_any(), valueMatcher); },
        peg$c62 = function(matcher) { return builders.build_matcher_find_item(matcher); },
        peg$c63 = function(matcher) { return builders.build_matcher_item(matcher); },
        peg$c64 = function() { return builders.build_matcher_item(builders.build_matcher_eol()); },
        peg$c65 = function() { return []; },
        peg$c66 = function(item, tail) { return [item].concat(tail); },
        peg$c67 = "-",
        ...
        peg$c86 = "string",
        peg$c87 = { type: "literal", value: "string", description: "\"string\"" },
        peg$c88 = "number",
        peg$c89 = { type: "literal", value: "number", description: "\"number\"" },
        peg$c90 = "boolean",
        peg$c91 = { type: "literal", value: "boolean", description: "\"boolean\"" },
        peg$c92 = "regex",
        peg$c93 = { type: "literal", value: "regex", description: "\"regex\"" },
        ...
        peg$c126 = /^[0-9a-fA-F]/,
        peg$c127 = { type: "class", value: "[0-9a-fA-F]", description: "[0-9a-fA-F]" },
        peg$c128 = /^[ \n\t\r]/,
    ...
    function peg$parsechar() {
      ...
      if (s0 === peg$FAILED) {
        ...
        if (input.substr(peg$currPos, 2) === peg$c95) {
          ...
          s1 = peg$FAILED;
          if (peg$silentFails === 0) { peg$expected(peg$c96, peg$currPos); }
        }
        if (s1 !== peg$FAILED) {
          peg$reportedPos = s0;
          peg$userFail = false;
        ...
        if (s0 === peg$FAILED) {
          ...
          if (input.substr(peg$currPos, 2) === peg$c98) {
            ...
            s1 = peg$FAILED;
            if (peg$silentFails === 0) { peg$expected(peg$c99, peg$currPos); }
          }
          if (s1 !== peg$FAILED) {
            peg$reportedPos = s0;
            peg$userFail = false;
          ...
          if (s0 === peg$FAILED) {
            ...
            if (s0 === peg$FAILED) {
              ...
              if (input.substr(peg$currPos, 2) === peg$c104) {
                ...
                s1 = peg$FAILED;
                if (peg$silentFails === 0) { peg$expected(peg$c105, peg$currPos); }
              }
              if (s1 !== peg$FAILED) {
                peg$reportedPos = s0;
                peg$userFail = false;
              ...
              if (s0 === peg$FAILED) {
                ...
                if (input.substr(peg$currPos, 2) === peg$c107) {
                  ...
                  s1 = peg$FAILED;
                  if (peg$silentFails === 0) { peg$expected(peg$c108, peg$currPos); }
                }
                if (s1 !== peg$FAILED) {
                  peg$reportedPos = s0;
                  peg$userFail = false;
